...
#+liquid: enabled
#+comments: true
#+xcowsay_utils_link: <a href="https://github.com/haude/xcowsay-utils" target="_blank">https://gist.github.com/killthekitten/4486585</a>
...
3. Add the following to /etc/ssh/login-notify.sh
  ...
  #+BEGIN_QUOTE
    ...
    if you want to used notifi-send instead you can replace it with
